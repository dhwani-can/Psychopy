...
expName = 'orientation discri'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\91982\\Desktop\\psychopy\\orientation discrimination\\orientation discri_lastrun.py',
